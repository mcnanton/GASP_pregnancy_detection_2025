...
![](imagenes/3_delimiting.png){fig-align="center" width="669" fig-alt="Diagram showing a patient's timeline. Coloured segments represent the reconstructed pregnancies based on the patients records, the result of the algorithm. Below, bold text indicates variables that characterise the pregnancie while regular text indicates operations performed"}
